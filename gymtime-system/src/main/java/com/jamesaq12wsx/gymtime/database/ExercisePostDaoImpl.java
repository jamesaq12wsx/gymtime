...
//
//        SimpleExercisePost simpleExercisePost = (SimpleExercisePost) exercisePost;
//
...
//
//        try {
//            exercisesJsonStr = mapper.writeValueAsString(simpleExercisePost.getExercises());
//        } catch (JsonProcessingException e) {
//            e.printStackTrace();
//        }
//
...
//                insertMarkSql,
//                new Object[]{
//                        simpleExercisePost.getCreatedBy(),
//                        simpleExercisePost.getPostTime(),
//                        simpleExercisePost.getClubUuid(),
//                        exercisesJsonStr,
//                        simpleExercisePost.getPrivacy().toString()});
//    }
//
//    @Override
